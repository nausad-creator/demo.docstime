...
@Component({
  selector: 'app-re-refer-form',
  templateUrl: './re-refer-form.component.html',
  styleUrls: ['./re-refer-form.component.css'],
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class ReReferFormComponent implements OnInit {
  genders = ['Male', 'Female'];
  peopleLoading = false;
  loading = false;
  ...
  checkWhereToNavigate = () => {
    ...
    if (`/${url[2]}` === '/facility-add-refer-case') {
      this.facilityService.forceReloadSentList();
