...
@Component({
  ...
  template: `
  <div class="appointmen-list card mb-3" style="cursor: pointer;" (click)="onClickViewPrivious(wholeObject)">
      <div class="d-flex text-appont">
        ...
        <div class="row align-items-center">
          ...
          <div class="col-md-4 text-xl-right btnsgrp-appointment" *ngIf="refercaseStatus === 'Accepted' || refercaseStatus === 'Completed'">
              ...
              <div class="text-primary"><img src="assets/img/done.svg" alt="" height="15px">Completed</div>
          </div>
        </div>
      </div>
    `,
