  ...
  <div class="appointmen-list card mb-3" style="cursor: pointer;" (click)="onClickViewPrivious(wholeObject)">
      <div class="d-flex text-appont">
        ...
        <div class="row align-items-center">
          ...
          <div class="col-md-4 text-xl-right btnsgrp-appointment" *ngIf="refercaseStatus === 'Rejected'">
              ...
              <div  class="text-alert"><img src="assets/img/close-icon.svg" alt="Rejected" height="15px"> Rejected</div>
            </div>
        </div>
      </div>
    `,
