...
@Component({
  selector: 'app-doc-contact-us',
  templateUrl: './doc-contact-us.component.html',
  styleUrls: ['./doc-contact-us.component.css'],
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class DocContactUsComponent implements OnInit {
  contactUs: FormGroup;
